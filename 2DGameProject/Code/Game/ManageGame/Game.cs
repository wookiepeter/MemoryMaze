...
namespace MemoryMaze
{
    class Game
    {
        ...
        void Tutorial()
        {
            levelList.Add(new Level("Assets/MapFiles/map00.txt", 64, new Vector2i(10,4), 1));
        ...
        void MainCampaign()
        {
            ...
            //levelList.Add(new Level("Assets/MapFiles/map04.txt", 64, new Vector2i(8,1), 0));
            //levelList.Add(new Level("Assets/MapFiles/map05.txt", 64, new Vector2i(5, 3), 0));
            //levelList.Add(new Level("Assets/MapFiles/map06.txt", 64, new Vector2i(5, 3), 0));
            //levelList.Add(new Level("Assets/MapFiles/map07.txt", 64, new Vector2i(5, 3), 0));
            //levelList.Add(new Level("Assets/MapFiles/map08.txt", 64, new Vector2i(5, 3), 0));
            //levelList.Add(new Level("Assets/MapFiles/map09.txt", 64, new Vector2i(5, 3), 0));
